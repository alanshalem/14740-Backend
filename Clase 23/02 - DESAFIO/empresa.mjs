...
const normalizedEmpresa = normalizr.normalize(originalData, empresa);
console.log(JSON.stringify(normalizedEmpresa).length);
console.log(util.inspect(normalizedEmpresa, false, 12, true));
...
console.log(util.inspect(denormalizedEmpresa, false, 12, true));
